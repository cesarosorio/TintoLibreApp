...
INNER JOIN material ON solicitudes.Id_material = material.Id_material
...
$consulta_mysql2="SELECT * FROM orden_solicitud WHERE `Id_solicitud` = '$id_solici'";
