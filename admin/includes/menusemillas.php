<ol class="breadcrumb"> 
    <li class="breadcrumb-item active">Menú de opciones lider.</li>
</ol>
...
<div class="card-deck">
  ...
  <div class="card"> 
    <div class="card-body">
      ...
      <p class="card-text"><a href="?contenido=newsemilla" class="btn btn-dark btn-block">Ir al modulo</a></p>
    </div>
  </div>
  ...
  <div class="card"> 
    <div class="card-body">
      ...
      <p class="card-text"><a href="?contenido=viewSemilla" class="btn btn-dark btn-block">Ir al modulo</a></p>
    </div>
  </div>  
  ...
  <div class="card"> 
    <div class="card-body">
      ...
      <p class="card-text"><a href="?contenido=ver_alerta" class="btn btn-dark btn-block">Ir al modulo</a></p>
    </div>
  </div>   
...
<br> 
<ol class="breadcrumb"> 
    <li class="breadcrumb-item active">Menú de opciones integrante.</li>
</ol>
